...
export default function Reels() {
  ...
  // Client-side guard: redirect if not logged in
  useEffect(() => {
  ...
  useEffect(() => {
    const fetchVideos = async () => {
      try {
        ...
        // If backend returns 401, redirect to login (session expired)
            ...
            >
              ...
              {hearts
                ...
                .map((heart) => (
                  ...
                  >
                    <span className="text-6xl text-pink-500 drop-shadow-lg">❤️</span>
                  </div>
                ))}
